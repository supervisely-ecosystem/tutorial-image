...
2. [upload images to Supervisely as NumPy matrix.](#2-upload-image-as-numpy-matrix)
3. [get information about images by id or name.](#3-getting-information-about-images)
4. [download images from Supervisely to local directory.](#4-download-image-to-local-directory)
5. [download images from Supervisely as NumPy matrix.](#5-download-image-as-rgb-numpy-matrix)
